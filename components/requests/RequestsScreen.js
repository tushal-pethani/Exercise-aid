...
const RequestsScreen = () => {
  ...
  const fetchRequests = async () => {
    setLoading(true);
    try {
      console.log('Current user ID:', user.id || user._id); // Debug log
      
      const response = await axios.get(`${API_URL}/requests`, {
        headers: { 'x-auth-token': token }
      });
      
      console.log('All requests:', JSON.stringify(response.data)); // Debug log
      ...
      console.log('Outgoing requests:', JSON.stringify(outgoing)); // Debug log
  ...
  const handleCancelRequest = async (requestId) => {
    ...
    try {
      ...
      console.log('Cancel request response:', response.status, response.data);
      ...
      console.error('Error details:', {
        ...
        requestURL: `${API_URL}/requests/${requestId}`,
            ...
            <View style={styles.emptyContainer}>
              ...
              {activeTab === 'outgoing' && (
                <TouchableOpacity 
                  ...
                  onPress={() => navigation.navigate('SearchPhysio')}
                >
                  <Text style={styles.findButtonText}>Find Physiotherapists</Text>
                </TouchableOpacity>
              )}
            </View>
          }
